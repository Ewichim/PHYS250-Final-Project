...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--outDir", help="Output directory", default="./TestDataUnflippedVertexCut4")
    parser.add_argument("-j", "--ncpu", help="Number of cores to use", default=40, type=int)
    parser.add_argument("-n", "--maxEvents", help="Number of events per bin", default='3000', type=str)
    ...
    pt_ranges = [(0.00, 0.10), (3.00, 10.00)]
    # pt = np.linspace(0,2,21)
    # maxEvents = str(1000)
    # options_list = []
    commands = []
    for pTHatMin, pTHatMax in pt_ranges:
        # fix numpy rounding
